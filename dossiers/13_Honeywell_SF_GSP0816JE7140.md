...
## Delta update — 2026-09-14 sweep: ✏️ PS30 went to Honeywell for signature Friday morning — yesterday's "in NCFR" entry is superseded

- **9/11 7:59 AM PT — Chapman → Honeywell (Khan, Sapir, Kroeger, Prager, Pitts, Garvey, Athar; cc Schreck, Johnson, Ingersoll), "NOTICE OF DRAFT MODIFICATION GS-P-08-16-JE-7140/PS30"** (`1a090fb956328ec4`): *"Please find attached the Draft Bilateral Modification PS30 to de-obligate residual funding associated with Menlo Park, and to incorporate attachment – ESPC San Francisco T.O. Schedules – Dated August 10, 2026. This modification additionally includes GSA's acceptance of the Honeywell SF ESPC Year 6, Version 4 M&V Report on March 17, 2026… Please review thoroughly, **sign block 15**, and return the modification for execution in the GSA Contract Writing System."* Attachment: *DRAFT SF30 Mod PS30 SFSC ESPC Menlo Residual De-Ob YR6 M&V & Revised Schedules.pdf*.
- **Workload ESC sheet, SF row, 9/11:** *"Modification PS30 was submitted to Honeywell on 9/11/2026. NCFR Review completed on 9/10/2026."* So the sequence was OGC 9/3 → NCFR 9/8–9/10 → Honeywell 9/11. The 9/11 sweep entry above ("in the file-review queue and has not executed") was true at 6 AM and stale by 8 AM; **the correct status this morning is: with Honeywell for bilateral signature.** No Honeywell acknowledgment or signed copy in the inbox as of 6:00 AM PT 9/14.
- **Annual Funding Requests sheet (Heidi, 9/11):** SF Year 7 row still reads *"Date Pending T.O. Schedule Incorporation"* for every milestone, $1,271,861.30, note dated 9/2 ("in legal review and pending") — not yet updated for the 9/11 transmittal.
- **Year 7 PR decision, restated for today:** Honeywell signing is the one remaining gate and it is out of GSA's hands. Two paths, both defensible: (a) build the PR against the PS30 schedules now — the attached TO set is the 8/10 accepted revision Matt already concurred in, so the numbers will not change on execution; route it and let the award mod catch up; or (b) build against AS11 and reconcile. **(a) is now the better answer** — it obligates the incorporated values and avoids a reconciliation, and the risk (Honeywell not signing before 9/30) is the same either way. Tell Brown/Poon today which one and the date.
- Placeholders: the 9/11 MDD still carries "performance year XX" / "9/00/2026"; the SF30 PDF was not opened this sweep (attachment not in Drive). If the acceptance letter in the executed package still says "Dated September 28, 2026," it will be wrong on its face — check the PDF before Honeywell signs.
- PS31 scope memo and the COR memo-to-file on the stipulated-value sentence: unchanged plan; 9/17 1:00 PT TRM/M&V review and 2:30 Chapman 1:1 are the venues.


### 9/15 sweep — Brown's fourth chase unanswered; schedules promised to Shandal
- **9/14 11:06 AM PT — Brown (BA61) chases the Year 7 PR a fourth time** (`1a0a11a0a5663581`). No reply from Matt through 6 AM PT 9/15. The 9/14 recommendation stands: **build against the PS30 schedules (8/10 accepted set) and give Brown/Poon a date today.** Battle Creek's PR routed 9/14; this is now the only one of the three FY-end obligations with no PR in motion.
- **9/14 2:51 PM PT — Matt → Shandal** (`1a0a1e77ba46ddd3`): SF TO3/ECM schedules coming "shortly." **9/15 4:30 AM PT — Shandal "Thanks," cc McGill** (`1a0a4d56b6e70888`). The schedules have not gone out yet — send the 8/10 set and the PS30 transmittal reference; the same reply can carry the PJKK as-modified TO3 for the title thread.
- No Honeywell acknowledgment of the PS30 draft (sent 9/11 7:59 AM) in the inbox.


### 9/16 sweep — Matt chose the AS11 path for Year 7; schedules to Finance; PY6 IM started
- **9/15 11:15 AM PT — Matt → Brown** (`1a0a6484fe1fb3d0`, cc Chung, Novoa, Wong, Ingersoll, Poon): PS30 is out in draft; *"I don't want to risk missing it if PS30 execution slips. Let's go ahead and build the PR now against the current AS11 schedule — the same approach we used on the LA Year 9 action — so the obligation is secured, and I'll reconcile it to PS30's final figures once that executes. I'll get this started right away."* That settles the 9/14 (a)-vs-(b) question the other way from this dossier's recommendation: **obligate against AS11 now, true up to PS30 later.** Defensible, and it is the same precedent Budget accepted for LA. No EASi routing notice for the SF Year 7 PR in the inbox as of 6 AM PT 9/16 — **the build is today's deliverable.**
- **9/15 9:07 AM PT — Matt → Shandal** (`1a0a5d319ddd40f9`, cc Doll, McGill, Chapman): two schedule sets, with the reconciliation order — (1) **executed Mod AS11 (3/2/2020)** governs every payment since; (2) **pending PS30** (8/21/2026 Excel + PDF; TO-1–TO-5 plus the monthly termination-liability schedule; Menlo removed effective 7/31/2025) governs from execution forward, *"so variances between paid amounts and this set are expected until PS30 executes."* Follow-up 12:43 PM with the attachments that had dropped (`1a0a698c81bd3d4a`); Shandal *"ok sounds good"* (`1a0a6af80ed80f11`). The Finance schedule request from 9/4 is closed.
- **HSPD-12, 9/15:** (a) **Stacy Garvey** asked for a card renewal (expires Dec 2026); Matt confirmed her active on 7140 (`1a0a65dacf6f50c0`); helpdesk: new PIV enters production end of month (`1a0a6963847de4ff`). (b) **PR08 — Jose Jaime Topete**: Garvey confirmed he is off the contract and needs no card (`1a0a63958e0bc06c`); Matt confirmed for the record cc Chapman and Mannucci (`1a0a6524243cd50e`); **helpdesk wants the badge in his possession returned with tracking** (`1a0a64886f48b4c7`; separate notice `1a0a646e2606de16`). Open until Honeywell ships it.
- **Drive, 9/15 3:20–4:30 PM PT — Matt staged the PY6 record under his own account:** Year 6 M&V Report V04 (3/13/2026) (`1XNZQYUos80_3j5OD05nxZhm5eZE1piEF`), the Appendix/witness forms (`1bLp93FDjyqXPBaZvkHdqxJfhJoGufeXT`), the FINAL review-comment workbook (`1FQKwpjIDx4t7tW91DhwiE7WXcvGQoJiA`; the copy in the shared folder was also touched, `1r-BDvz1-GxewpaYZkOMh2ATVKZyWMh2i`), and a new sheet **"GSA_R9_San_Fran_ESPC_PY6_ESPC_Instructional_Memo"** (`1SKly5chC0tzClFBBKHgrX8hNJjUTaaZsrrpsNvahM5s`) built on the PBS ESPC Performance Team R&R matrix. This is the first Zone 7 instance of the **IM + comment form per review** convention adopted at the 9/14 M&V Team Meet — PY6 SF is the pilot.
- **Scorecard correction sent 9/15** (`1a0a6ca2ac6d977c`, item 6): the ESC Scorecard shows SF PY6 "never received"; GSA's acceptance of V04 stands as of **3/17/2026**, confirmed to Honeywell 7/13/2026 cc Chapman. Berezovskiy/Frank asked to mark received/accepted and clear the witnessing flag.
- Still no Honeywell acknowledgment of the PS30 draft. Pitts is live on the LA thread this morning; a nudge on PS30 in the same breath costs nothing.

- **9/17 sweep.** **Brown 9/16 8:16 AM PT:** *"Yes, please get the PR going off the AS11 schedule."* (`1a0aaca746d4c71b`). No EASi routing notice for the SF Year 7 PR in the inbox through 6 AM PT 9/17 — **the build is now two days past Matt's "right away."** **Chapman 9/16 9:32 AM chased Honeywell for a status on PS30 review and signing** (`1a0ab106edc22fc1`, to Khan, Sapir, Kroeger, Prager, Pitts, Garvey, Athar); no reply. Berezovskiy (9/16, `1a0ab9bf6286a616`, item 6): the scorecard's PY6 "never received" flag exists because no report was ever submitted through the intake form and the savings values are blank — **submit the V04 report through the form** (it is already staged in Drive, `1XNZQYUos80_3j5OD05nxZhm5eZE1piEF`) and the flag clears.
...
## Delta update — 2026-09-25 sweep: 🔴 Year 7 PR M0025 built and pre-validated, then stalled: Menlo Park fails BFY26, 13 legacy lines under-committed, and Chapman says the draft PR now blocks PS30 execution — Budget will request an EASi bypass; three business days

- **9/24 12:59 PM PT — Matt → Brown** (`1a0d50016e8169f0`; cc Chung, Novoa, Wong, Ingersoll, Poon): **M0025 built off AS11** — Year 7, TO-3 Term 7, **$1,432,402.14** across CLINs 0032–0034, 39 FY2026 strings, fund 192X. Pegasys pre-validation (EASi task 12:53 PM, `1a0d4fb43ec6060d`) returned two items: (1) **Menlo Park CA0915OO** — Pegasys won't accept the building for BFY 2026; three strings (lines 341, 353, 361) totaling **$78,965.73**; Menlo was removed effective 8/1/2025 (CLIN 0031) but AS11 TO-3 still sets the Year 7 amount until PS30 executes; Matt recommends holding $1,432,402.14 and redistributing the Menlo share pro rata across the 12 remaining buildings within each CLIN (reallocation reconciled to the cent, ready on concurrence); (2) **lines 34–46** — 13 legacy lines committed below their closed amounts, totaling **$520,000**, matching CLIN 0010 Construction Period Savings; M0025 didn't touch them; needs a budget/OAM fix or a non-blocking ruling. Routing set: Ingersoll (AO), Chapman (notification), Brown (FCO); "will be initiated once these two items are resolved."
- **1:42 PM — Matt adds Chapman** ("My apologies for not including you sooner," `1a0d527dbc5ef2fd`).
- **2:21 PM — Chapman** (`1a0d54bd0138d527`): *"We should have waited until PS30 was executed before drafting a PR Mod. I tried to execute modification PS30 today, but there is a validation error. We've only been trying to get this executed since March 2026. EASi says the draft PR Mod must be cancelled before executing PS30. There's probably another issue as well, so I'll have to submit an EASi Help Request. Thanks a lot."* Note: Brown directed the AS11 build on 9/16 (`1a0aaca746d4c71b`) and Chapman was not on that thread; PS30 has no Honeywell signature (third request went out 7:38 AM the same day, `1a0d3db1cfc70e0f`), so "execute PS30" there can only mean the EASi mod record, not a bilateral award.
- **4:56 PM — Brown** (`1a0d5d9aa4e825b6`): (1) the redistribution is fine from the budget side, within approved funding; (2) **he will have to request an EASi interface bypass** since the legacy lines were removed from prior PR/award mods.
- Chapman's **3rd request** to Honeywell on PS30 (`1a0d3db1cfc70e0f`); no reply. Cawthorne accepted the 10/1 cadence.
- **COR file:** Thursday evening Matt built *08 COR File Index_GS-P-08-16-JE-7140* (`1mlzfEmRFxsQGR6pU2HyEedTvPdyfVLcTbX_hOyoYZbk`) and filed the AS11 SF30 and schedules, the PS30 revised schedules (8/21), the Menlo termination letter, settlement documentation and review comments under standardized names.

**COR read.** Two systems conflicts, one sequencing conflict. Menlo's BFY26 block is solved by the pro-rata redistribution Brown accepted. The $520,000 legacy-line problem is Budget's (bypass). The sequencing conflict is the one that can miss 9/30: EASi will not execute PS30 while a draft PR mod exists on the order, and Chapman reads that as the PR's fault, but PS30 can't execute as a bilateral anyway without Honeywell's signature. The obligation, not PS30, is the FY-end requirement. Path: cancel the draft only if Chapman confirms he can execute PS30 *today* and Honeywell has signed; otherwise keep M0025, enter the redistribution, let Brown's bypass clear lines 34–46, and route. Either way the CO needs to say which he wants in writing.

**COR actions 9/25:** (1) Reply to Chapman and Brown together, two lines up top: M0025 is the FY26 obligation; PS30 cannot execute bilaterally until Honeywell signs (third request unanswered); recommend M0025 proceed with the redistribution and the bypass, and PS30 follow. Ask Chapman to confirm by noon. (2) Enter the Menlo redistribution as soon as Chapman concurs. (3) Track Brown's bypass request. **Three business days to 9/30.**


---

## Delta update — 2026-09-25 PM: PS30 executed; M0025 auto-cancelled; Year 7 PR rebuilt as M0026 at $1,228,251.35 on the PS30 schedules and routed — 18 legacy-line messages ride on Brown's bypass

- **9:36 AM PT — EASi: Award Mod Finalized, PS30** (`1a0d96d3c74848da`) and **PR Mod M0025 cancelled** "because it was in draft when the award mod was finalized" (`1a0d96d3dab0d6d1`). So Chapman executed PS30 unilaterally in EASi Friday morning; whether Honeywell signed is not shown in the notices, but Chapman's 12:35 PM notice to Honeywell calls it the "Executed Bilateral Modification PS30" (`1a0da10f77cb400b`, with *Executed SF30 Mod PS30 SFSC ESPC Menlo Residual De-Ob YR6 2026 09 25.pdf*; to Sapir, Correa, Khan, Kroeger, Prager, Pitts, Athar, Garvey, Harrison): de-obligates residual Menlo Park funding, Year 6 M&V acceptance, incorporates the **ESPC San Francisco T.O. Schedules dated August 8, 2026**. **The Year 6 acceptance letter is now issuable** (it was gated on PS30 per the 9/22 intake note).
- **9:47 AM — Matt → Chapman** (`1a0d97768100e28d`); **10:30 AM — Chapman**: EASi won't allow draft PR mods while a mod is pending; "you're clear to move forward with the year 7 PR now" (`1a0d99e9602c914a`). 10:37 Matt: will rebuild against PS30 (`1a0d9a511caafc77`).
- **10:55 AM — Matt → Brown:** FY26 or FY27? **11:13 AM — Brown** (`1a0d9c64c66cc647`): FY26; "The deadline for FY26 PRs is today"; Monday works if Acquisition agrees. **11:19 AM — Matt:** rebuilding today at **$1,228,251.35** (TO-3 Term 7, Menlo strings removed); asks Chapman whether Monday holds (`1a0d9cae52c5471d`). **11:48 AM — Chapman** (`1a0d9e647502b365`): "get the PR to me as soon as possible… I honestly didn't plan for this modification… perhaps work a few hours of overtime this weekend… this modification (like all others on this task order) will include validation errors, so I'm excited."
- **1:54 PM — Pegasys pre-validation task on M0026** (`1a0da59339175940`, trashed). **2:15 PM — Matt → Chapman** (`1a0da6c191947bb9`) and **2:22 PM — Matt → Brown** (`1a0da72c450f531f`): **M0026 routed** — CLIN 0032 principal $664,189.24; CLIN 0033 interest $470,016.25; CLIN 0034 TRM/M&V $94,045.86; 36 FY26 strings; includes the PS30 de-obligation of $61,745.76 on prior-year Menlo lines; **net PR amount committed $1,166,505.59**; executed PS30 and TO-3 attached; routing Ingersoll → Brown. Pre-validation passed on all 36 new lines; **18 messages on unchanged legacy lines** (lines 34–46, the $520,000 CLIN 0010 set; plus 193, 221, 286, 314, 322, prior-year Menlo lines touched by the de-obligation) — "adding the five Menlo Park lines to the CLIN 0010 lines already in the bypass request should let the PR clear certification before year-end." Drive: *M0026_Accounting_Strings_Import_35* (`1Q20BjEWty_cweHFI4U5vwkNN505K1z_60VjHG-Gkq7k`, 1:13 PM).
- **HSPD-12 (Casiano) on Topete** (`1a0da1f354be47b0`, 12:50 PM; to Gjeltema, cc Chapman, Matt): can report the card to FPS and file the form if collection attempts are exhausted; asks which reason (lost / stolen / uncollectible variants / refused); return address Fort Worth.
- Drive housekeeping: new top-level folder "08 NDER2 SF Honeywell GS-P-08-16-JE-7140" (`1qjDCiyGNk6c0yGwZ5oNh4-LnawyU3qKt`, 9:02 AM).
